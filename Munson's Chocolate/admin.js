...
let allOrders = [];
const DISPLAY_URL = 'https://script.google.com/macros/s/AKfycbz58yX_syI1WNspqv3rA8QHGNbWvsdlnqx9UBuSHNdJwXfCXxDCu-cxwoGTyMD3xtYw/exec';
...
function setupControls() {
    ...
    document.getElementById('clear-orders').addEventListener('click', async () => {
        if (confirm('Are you sure you want to delete ALL orders? This cannot be undone!')) {
            const adminEmail = sessionStorage.getItem('adminEmail');
            const COLLECTION_URL = 'https://script.google.com/macros/s/AKfycbxcpwQOvlLmthCS7oO94ecNe1veiBo6BpQi-wqX6kldgKbNgesrHSXx07eglu96UUUz/exec';
