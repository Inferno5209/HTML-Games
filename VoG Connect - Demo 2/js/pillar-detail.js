...
const pillarData = {
    ...
    'social-skills': {
        ...
        examples: [
            { title: 'Team Project', description: 'Students collaborated on a complex project requiring effective communication and teamwork.' },
            { title: 'Leadership Program', description: 'Students organized and led school-wide events and initiatives.' }
        ],
        resources: [
            { title: 'Teamwork Assessment Tool', link: 'resources/teamwork-assessment.pdf' },
            { title: 'Communication Skills Workbook', link: 'resources/communication-workbook.pdf' }
        ]
    },
