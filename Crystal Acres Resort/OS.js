...
// CONFIGURATION
        ...
        async function handleGoogleLogin(response) {
            ...
            showStatus('Verifying Google Account...', 'info');

            // Send the Google JWT token to the backend for verification
            const res = await sendRequest('googleLogin', { token: response.credential });
            ...
            if (res.status === 'success') {
                ...
                errorEl.textContent = res.message || "This Google Account is not authorized as an admin.";
        ...
        async function handleLogin(e) {
            e.preventDefault();
            // Deprecated: Email/password login is replaced by Google Sign-In.
        }
